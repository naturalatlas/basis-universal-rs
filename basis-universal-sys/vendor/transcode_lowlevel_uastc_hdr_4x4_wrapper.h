...
extern "C" {
    ...
    struct LowLevelUastcHdr4x4Transcoder {
        basist::basisu_lowlevel_uastc_hdr_4x4_transcoder *pTranscoder;
    };

    LowLevelUastcHdr4x4Transcoder *low_level_uastc_hdr_4x4_transcoder_new() {
        LowLevelUastcHdr4x4Transcoder *transcoder = new LowLevelUastcHdr4x4Transcoder;
        transcoder->pTranscoder = new basist::basisu_lowlevel_uastc_hdr_4x4_transcoder();
        return transcoder;
    }

    void low_level_uastc_hdr_4x4_transcoder_delete(LowLevelUastcHdr4x4Transcoder *transcoder) {
        delete transcoder->pTranscoder;
        delete transcoder;
    }

    bool low_level_uastc_hdr_4x4_transcoder_transcode_slice(
        LowLevelUastcHdr4x4Transcoder *transcoder,
        void* pDst_blocks,
